...
{
public:
	void getDayInWeek(short*);
	void getWhenString(ZCalendarEvent&, QString&);
	void getWhenString(ZCalendarEvent&, QString&, QString&, QString&, QString&, QString&);
	void readICalendar(QString const&, QString const&, ZCalendarEvent&, CAL_ICALENDAR_METHOD_ENUM_T&, bool);
	void writeProperty(icalproperty_impl*, QFile*);
	void writeICalendar(ZCalendarEvent&, QString const&, CAL_ICALENDAR_METHOD_ENUM_T, CAL_ICALENDAR_RESPONSE_ENUM_T, QString);
	void writeVTimeZone(QFile*, ZCalendarEvent&);
	void event2icalendar(ZCalendarEvent&, icalcomponent_impl*, CAL_ICALENDAR_METHOD_ENUM_T, CAL_ICALENDAR_RESPONSE_ENUM_T, QString);
	void icalendar2Event(ZCalendarEvent&, icalcomponent_impl*, QString const&, bool);
	void toMeetingResponse(ZCalendarEvent&, CAL_ICALENDAR_RESPONSE_ENUM_T, QString, QString, QString);
	void saveMeetingRequest(ZCalendarEvent&);
	void writeMeetingRequest(ZCalendarEvent&, QString const&, CAL_ICALENDAR_METHOD_ENUM_T);
	void processMeetingRequst(ZCalendarEvent&, CAL_ICALENDAR_RESPONSE_ENUM_T);
	void removeMeetingRequest(ZCalendarEvent&);
	void writeMeetingResponse(ZCalendarEvent&, QString const&, CAL_ICALENDAR_RESPONSE_ENUM_T, QString);
	void getRepeatPatternString(ZCalendarEvent&, QString&);
	void getMeetingRequestString(ZCalendarEvent&, QString&, CAL_ICALENDAR_METHOD_ENUM_T);
	void checkMeetingRequestOutdated(ZCalendarEvent&);
	CAL_ENG_ICalendar();
	~CAL_ENG_ICalendar();
	
};

#endif //CAL_ENG_ICALENDAR_H
