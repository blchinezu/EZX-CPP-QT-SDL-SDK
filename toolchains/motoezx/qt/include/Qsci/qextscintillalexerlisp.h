// This defines the interface to the QextScintillaLexerLisp class.
//
// Copyright (c) 2004
// 	Michael Neuroth
// 
...
//! lexer.
class QEXTSCINTILLA_EXPORT QextScintillaLexerLisp : public QextScintillaLexer
{
	Q_OBJECT
...
public:
	...
	QextScintillaLexerLisp(QObject *parent = 0,const char *name = 0);

	//! Destroys the QextScintillaLexerLisp instance.
	virtual ~QextScintillaLexerLisp();
...
private:
	...
	QextScintillaLexerLisp(const QextScintillaLexerLisp &);
	QextScintillaLexerLisp &operator=(const QextScintillaLexerLisp &);
#endif
};
