// This defines the interface to the QextScintillaLexerLua class.
//
// Copyright (c) 2005
...
#ifndef QEXTSCINTILLALEXERLUA_H
#define QEXTSCINTILLALEXERLUA_H
...
//! \brief The QextScintillaLexerLua class encapsulates the Scintilla Lua
//! lexer.
class QEXTSCINTILLA_EXPORT QextScintillaLexerLua : public QextScintillaLexer
{
	Q_OBJECT
...
public:
	...
	//! Construct a QextScintillaLexerLua with parent \a parent and name
	//! \a name.  \a parent is typically the QextScintilla instance.
	QextScintillaLexerLua(QObject *parent = 0,const char *name = 0);

	//! Destroys the QextScintillaLexerLua instance.
	virtual ~QextScintillaLexerLua();
...
private:
	...
	QextScintillaLexerLua &operator=(const QextScintillaLexerLua &);
#endif
};
