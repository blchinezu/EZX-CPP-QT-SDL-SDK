...
class Q_EXPORT QApplication : public QObject  //fox size: $44
{
    Q_OBJECT
public:
...
private:
    ...
    int		     app_argc;  //fox f: $24
    char	   **app_argv;  //fox f: $28
    bool	     quit_now;  //fox f: $2c
    int		     quit_code; //fox f: $30
    ...
    QList<QTranslator> *translators;   //fox f: $34
#ifndef QT_NO_SESSIONMANAGER
    QSessionManager *session_manager;  //fox f: $38
    QString	     session_id;           //fox f: $3C
    bool	     is_session_restored;  //fox f: $40
#endif
