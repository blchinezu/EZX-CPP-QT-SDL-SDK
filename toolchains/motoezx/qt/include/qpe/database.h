...
class QPC_EXPORT Database : public QObject
{
    Q_OBJECT
...
class QPC_EXPORT DatabaseView : public QObject
{
    Q_OBJECT
...
class QPC_EXPORT DatabaseDefaultView : public DatabaseView
{
public:
