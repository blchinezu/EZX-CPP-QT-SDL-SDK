...
{
public:
	ZSMS_OutgoingMsg(QString const& num, QString const& content="");  // Number, Content
	ZSMS_OutgoingMsg(ZSMS_OutgoingMsg const&);
	~ZSMS_OutgoingMsg();
 	
	QString getAddress(void) const;
	QString getMsgBody(void) const;
...
public:
	...
	void vfnRspnsOfGetTextTemplate(unsigned int, int, QStringList const&);
...
public:
	...
	QString getAddress(void) const;
	QString getMsgBody(void) const;
	QDateTime getSentTime(void) const;
