/****************************************************************************
** $Id: qt/src/dialogs/qfiledialog.cpp   2.3.8   edited 2004-08-05 $
**
...
void QFileDialog::init()
{
    ...
    //d->moreFiles->setMinimumHeight(180);
    ...
    d->fileL = new QLabel( nameEdit, tr("&Name:"), this );
    d->typeL = new QLabel( d->types, tr("&Type:"), this );
...
void QFileDialog::deleteFile( const QString &filename )
{
    ...
    if ( ZMessageBox::information( this,NULL,
...
void QFileDialog::done( int i )
{
	...
	for ( uint f = 0; f < selection.count(); f++ ) {
		...
		ZMessageBox::timerMessage( this,NULL, tr("Error!  %1\nFile not found.\nCheck path and filename.").arg( file ),1 );
		return;
	    }
#endif
	}
...
void QFileDialog::urlFinished( QNetworkOperation *op )
{
	...
	if ( isVisible() )
	    ZMessageBox::timerMessage( this, NULL, tr( "ERROR!" )+op->protocolDetail(),1 );
