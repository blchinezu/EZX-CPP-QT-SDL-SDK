/*@MOT@ ----- NOTICE ------
 *@MOT@
 *@MOT@ This file is released outside Motorola under GPL v2 license.
 *@MOT@
 *@MOT@ ONLY Authorized Motorolans are permitted to EDIT, COPY or BRANCH this file.
 *@MOT@
 *@MOT@ Send questions, edit requests, copy requests, and branch requests to 
 *@MOT@ QtCCB@motorola.com to contact those Authorized to change this file.
 *@MOT@ In the e-mail be sure to include this file's full pathname and SCM version.
 *@MOT@ ----- NOTICE -----
 *@MOT@*/
