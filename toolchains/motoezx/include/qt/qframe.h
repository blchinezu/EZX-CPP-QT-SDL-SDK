...
class Q_EXPORT QFrame : public QWidget			// frame class  //fox Size: $E4, QWidget $C4
{
    Q_OBJECT
...
#endif
    QRect	frect;      //fox f: $C4
    int		fstyle;     //fox f: $D4
    short	lwidth;     //fox f: $D8
    short	mwidth;     //fox f: $DA
    short	mlwidth;    //fox f: $DC
    short	fwidth;     //fox f: $DE
