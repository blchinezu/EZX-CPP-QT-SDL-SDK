...
class Q_EXPORT QButton : public QWidget  //fox size: $d4, QWidget: $C4
{
    Q_OBJECT
...
private:
    QString	btext;             //fox f: $C4 
    QPixmap    *bpixmap;       //fox f: $C8 
    uint	toggleTyp	: 2;   //fox f: $CC 
    uint	buttonDown	: 1;
    uint	stat		: 2;
    uint	mlbDown		: 1;
    uint	autoresize	: 1;
