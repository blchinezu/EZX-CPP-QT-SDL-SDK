...
*************************************************************/
/*#ifndef ZCALENDAREVENT_H
#define ZCALENDAREVENT_H

class ZCalendarEvent
{
public:
	void setBoolean(ZCalendarEvent::CalendarEventField_T, bool);
	void addAttendee(ZCalendarEvent::Attendee_T&);
	void setExceptID(unsigned int);
	void setTimeZone(QString&);
	void setTimeZone(ZCalendarTimeZone_T const&);
	void setAttendees(QValueList<ZCalendarEvent::Attendee_T>&);
	void setAttendees(QString const&);
	void setOrganizer(QString&);
	void setOrganizer(ZCalendarEvent::Attendee_T&);
	void setCategories(QValueList<QString>&);
	void setCategories(QString&, QString);
	void removeFromCategory(QString&);
	void commit();
	void setInt(ZCalendarEvent::CalendarEventField_T, int);
	void setUID(unsigned int);
	void setDate(ZCalendarEvent::CalendarEventField_T, long);
	void setRepeat(ZCalendarRepeat*);
	void setString(ZCalendarEvent::CalendarEventField_T, QString const&);
	ZCalendarEvent(ZCalendarEvent const&);
	ZCalendarEvent();
	ZCalendarEvent(ZCalendarEvent const&);
	ZCalendarEvent();
	~ZCalendarEvent();
	void operator=(ZCalendarEvent const&);
	void getBoolean(ZCalendarEvent::CalendarEventField_T, bool&);
	void getExceptID();
	void getTimeZone(ZCalendarTimeZone_T&);
	void getTimeZone();
	void hasExceptID();
	void hasTimeZone();
	void isOrganizer();
	void getAttendees(QValueList<ZCalendarEvent::Attendee_T>&);
	void getAttendees();
	void getOrganizer(ZCalendarEvent::Attendee_T&);
	void getOrganizer();
	void hasOccurDate();
	void checkTimeZone(ZCalendarTimeZone_T const&);
	void getCategoryName();
	void isMeetingRequest();
	void getDurationMinutes();
	void getInt(ZCalendarEvent::CalendarEventField_T, int&);
	void getUID();
	void getDate(ZCalendarEvent::CalendarEventField_T, long&);
	void isRepeat();
	void getRepeat();
	void getString(ZCalendarEvent::CalendarEventField_T, QString&);
	
};

#endif //ZCALENDAREVENT_H
*/
