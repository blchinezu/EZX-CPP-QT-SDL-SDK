...
*************************************************************/
/*#ifndef ZCALENDARREPEAT_H
#define ZCALENDARREPEAT_H

class ZCalendarRepeat
{
public:
	void addExceptDate(long, ZCalendarRepeat::ExceptionType_T);
	void getOccurrences(long&, long&, long&, int, ZCalendarTimeZone_T&, QValueList<long>&);
	void setExceptDates(ZCalendarRepeat::ExceptionType_T, QValueList<long>&);
	void clearExceptDates(ZCalendarRepeat::ExceptionType_T);
	void isValidOccurDate(long&, ZCalendarTimeZone_T&, long);
	void removeExceptDate(long, ZCalendarRepeat::ExceptionType_T);
	void setInt(ZCalendarRepeat::CalendarRepeatField_T, int);
	void setDate(ZCalendarRepeat::CalendarRepeatField_T, long);
	ZCalendarRepeat(ZCalendarRepeat const&);
	ZCalendarRepeat();
	ZCalendarRepeat(ZCalendarRepeat const&);
	ZCalendarRepeat();
	~ZCalendarRepeat();
	void operator=(ZCalendarRepeat const&);
	void getEndDate(QDateTime&, int, QDateTime&);
	void getEndDate(long&, int, ZCalendarTimeZone_T&, long&);
	void getWeekDay(int);
	void isExceptDate(long, ZCalendarRepeat::ExceptionType_T);
	void hasExceptDate(ZCalendarRepeat::ExceptionType_T);
	void getDateInMonth(int, int);
	void getExceptDates(ZCalendarRepeat::ExceptionType_T, QValueList<long>&);
	void getOccurrences(QDateTime&, QDateTime&, QDateTime&, int, QValueList<QDateTime>&);
	void getNextOccurrence(QDateTime&, QDateTime&, QDateTime&);
	void getNextOccurrence(long&, long&, ZCalendarTimeZone_T&, long&);
	void getNextOccurrenceEx(long&, long&, ZCalendarTimeZone_T&, long&);
	void getInt(ZCalendarRepeat::CalendarRepeatField_T, int&);
	void getDate(ZCalendarRepeat::CalendarRepeatField_T, long&);
	void getCount(QDateTime&, QDateTime&, int&);
	void getCount(long&, long&, ZCalendarTimeZone_T&, int&);
	void operator==(ZCalendarRepeat const&);
	
};

#endif //ZCALENDARREPEAT_H
*/
