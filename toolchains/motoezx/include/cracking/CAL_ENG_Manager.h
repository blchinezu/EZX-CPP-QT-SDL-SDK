...
class CAL_ENG_Manager
{
public:
	void addCategory(QString&);
	void addNewAlarm(ZCalendarEvent const&, bool);
	void eventToVCal(ZCalendarEvent&, QArray<char>&);
	void removeEvent(unsigned int);
	void toLiteEvent(ZCalendarEvent&, CAL_LITE_EVENT_T&);
	void toLocalTime(long, QDateTime&, bool);
	void updateEvent(ZCalendarEvent&, bool);
	void vCalToEvent(QArray<char>&, ZCalendarEvent&);
	void addQuickText(CAL_QUICK_TEXT_T, QString&);
	void getAllEvents(QValueList<ZCalendarEvent>&);
	void getSetupInfo(CAL_SETUP_T, int&);
	void removeEvents(QDateTime&, QDateTime&);
	void resetProfile(ZCalendarEvent*);
	void searchEvents(ZCalendarSearchType_T, long&, long&, bool, QValueList<ZCalendarEvent>&);
	void setSetupInfo(CAL_SETUP_T, int);
	void slotReceived(QCString const&, QArray<char> const&);
	void dbDataChanged();
	void fromLocalTime(QDateTime&, long&, bool);
	void getCategoryID(QString&);
	void getQuickTexts(CAL_QUICK_TEXT_T, QValueList<QString>&);
	void removeCategory(QString&, bool);
	void renameCategory(QString&, QString&);
	void resetAllAlarms();
	void toSearchResult(ZCalendarEvent&, CAL_SEARCH_RESULT_T&);
	void getCategoryName(unsigned int, QString&);
	void getMeetingOfDay(QDate const&, QValueList<CAL_LITE_EVENT_T>&);
	void isExistingEvent(unsigned int, unsigned int);
	void autoDeleteEvents();
	void getAllCategories(QValueList<CAL_ENG_CATEGORY_T>&);
	void getAllCategories(QValueList<QString>&);
	void getLocalTimeZone();
	void registerNewAlarm(ZCalendarEvent&, QDateTime, CAL_ALARM_TYPE_T, bool);
	void getCategoryByName(QString&, CAL_ENG_CATEGORY_T&);
	void makeProfileActive(ZCalendarEvent&);
	void addEventEditExcept(ZCalendarEvent&, bool);
	void getEventEditExcept(unsigned int, ZCalendarEvent&);
	void getEventEditExcept(unsigned int, long&, ZCalendarEvent&);
	void getEventEditExcepts(unsigned int, QValueList<ZCalendarEvent>&);
	void getEventsByCategory(unsigned int, QValueList<ZCalendarEvent>&);
	void getEventsByAlarmType(CAL_ALARM_TYPE_T, QDateTime&, QValueList<CAL_LITE_EVENT_T>&);
	void getNextAlarmedEvents(long&, QValueList<ZCalendarEvent>&);
	void deleteEventEditExcept(unsigned int, bool);
	void updateEventEditExcept(ZCalendarEvent&, bool);
	void deleteEventEditExcepts(unsigned int);
	void enableNotifyDataChange(bool);
	void getRemoveAfterDateTime(QDateTime&);
	void getQuickTextFilePathName(CAL_QUICK_TEXT_T, QString&);
	void addEventDeleteExceptByDate(unsigned int, long);
	void endSync();
	void addEvent(ZCalendarEvent&, bool);
	void getEvent(QString const&, ZCalendarEvent&);
	void getEvent(unsigned int, ZCalendarEvent&);
	void getEvent(unsigned int, unsigned int, long*, ZCalendarEvent&);
	void beginSync();
	void copyEvent(ZCalendarEvent const&, long*, ZCalendarEvent&);
	void getAllIDs(QValueList<unsigned int>&);
	void getEvents(QDateTime&, QDateTime&, QValueList<CAL_LITE_EVENT_T>&);
	void getEvents(QDateTime&, QDateTime&, QValueList<CAL_SEARCH_RESULT_T>&);
	void getEvents(long const&, long const&, QValueList<CAL_LITE_EVENT_T>&);
	void getEvents(long const&, long const&, QValueList<CAL_SEARCH_RESULT_T>&);
	void removeAll();
	void saveEvent(ZCalendarEvent&);
	CAL_ENG_Manager();
	~CAL_ENG_Manager();
	
};

#endif //CAL_ENG_MANAGER_H
*/
