...
public:
    ...
    virtual int getPackageType(void);
    virtual void setPackageType(int);
    virtual QString getPtfText(void);
    virtual void setPtfText(QString const&);
    virtual QPixmap *getPtfPixmap(void);
    virtual void setPtfPixmap(QPixmap const&);
    virtual QString getPtfIconId(void);
    virtual void setPtfIconId(QString const&);
    */
    
    /* Types are undetermined */
    static int bflex;
    static int flex_set;
    static int pipe_open_count;
    static int private_pipe;

    static int createWritePipe(void);
    static int getWritePipe(void);
    static void closePipe(void);

    void setPackageType(void);
    void setPtfPixmap();
    void setPtfPixmap(QString const&);
    void setPtfText();
    void setPtfOverlay(QString const&);
    int getPacketId(void);
    bool getTotalRectangle(void);
    bool isFlexBitSet(void);
    void report(void);
    int sendPackage(int, QRect, int, int, QString, QString);

    void fillInHeadTime(unsigned char *pktbuf, int);
    int fillInIcon(unsigned char *pktbuf, QString);
    int fillInPayloadSend(unsigned char *pktbuf, int);
    void fillInRect(unsigned char *pktbuf, int, int, int, int);
    void fillInRect(unsigned char *pktbuf, QRect);
    void fillInState(unsigned char *pktbuf);
    int fillInText(unsigned char *pktbuf, QString);
    void fillInType(unsigned char *pktbuf);

    int			m_pktid1_9c;
    int			m_pktid2_a0;
    int			m_pkgtype_a4;
    QString		m_ptf_text_a8;
    QString		m_ptf_iconid_ac;
    QPixmap		*m_ptf_pixmap_b0;
    QPixmap		*m_ptf_overlay_b4;
