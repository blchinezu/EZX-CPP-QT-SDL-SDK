...
private:	// Disabled copy constructor and operator=
    ...
    /*
     * Below was copied from Qt 2.3.10, in the interest of
     * compatibility with Qtopia/OPIE.
     */
public:
    // Not in Qt 2.3.7
    enum PixelMetric {
	    ...
	    TabHMargin,
	    LastPixelMetric };
    int pixelMetric(PixelMetric) const { return ComboBoxFocusMargin; }

    // Not in Qt 2.3.7
    enum ExtendedColor {
	    AlternateBase,
	    LastExtendedColor };
    QBrush extendedBrush(ExtendedColor) const { return QBrush(); }
    // Not in Qt 2.3.7
